...
function love.load()
	...
	assert(love.graphics.getSupported("canvas"), "This graphics card does not support canvases.")
	assert(love.graphics.getSupported("npot"), "This graphics card does not support non power-of-two canvases.") 
